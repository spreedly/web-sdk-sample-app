/**
 * Tokenize (SDK hosted fields catalogue) — optional catalogue fields mount as
 * Spreedly-hosted iframes via inAppElements(), plus custom validator demos.
  ...
  if (config.hostedSubmitButton) {
    sdk.on('submitClick', (formFields) => {
      ...
      sdk.submit(
        ...
        {
          metadata: {
            source: 'tokenize-catalogue-flow-demo',
