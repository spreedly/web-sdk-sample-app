...
const HOSTED_CATALOGUE_FIELDS = Object.freeze(['first_name', 'last_name', 'expiry']);
...
function tokenizeNewCard() {
  ...
  // Catalogue values are read from hosted iframes; do not pass merchant formData.
  sdk.submit({});
}
    ...
    container.innerHTML = `
      ...
      <div class="result-details">
        <div class="result-detail-row">
          ...
          <span class="result-detail-value">${SpreedlyUtils.escapeHtml(data?.token || 'N/A')}</span>
        </div>
        <div class="result-detail-row">
