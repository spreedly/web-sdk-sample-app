...
### Added
- **ACH payments** (HC-1126): `setupACHPayment(config)`, `submitACHPayment()`,
  and `clearACHPayment()` methods plus `achTokenGenerated` and `achPaymentError`
  events for tokenizing US/Canadian bank accounts.
