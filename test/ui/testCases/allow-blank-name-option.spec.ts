...
test.describe("Allow Blank Name Option - Monorepo", () => {
  ...
  test("should allow blank name when option is enabled in tokenize flow with Express Checkout", async ({
    ...
    await helperFunctions.verifyResultCard(page, TEST_DATA.CARD_FIRST_SIX_DIGITS_VISA, TEST_DATA.CARD_LAST_FOUR_DIGITS_VISA, { year: getValidYearString(), month: TEST_DATA.EXPIRY_MONTH }, TEST_DATA.CACHED_STORAGE_STATE);
  });
