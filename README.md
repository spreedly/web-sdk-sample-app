...
The latest released version is **`1.4.0`**, released on 30th July'26, available at:

- Hosted Fields: [`https://core.spreedly.com/checkout/sdk/1.4.0/index.js`](https://core.spreedly.com/checkout/sdk/1.4.0/index.js)
- Express Checkout: [`https://core.spreedly.com/checkout/elements/1.4.0/express-checkout.js`](https://core.spreedly.com/checkout/elements/1.4.0/express-checkout.js)
