...
The latest released version is **`1.3.1`**, released on 23rd July'26, available at:

- Hosted Fields: [`https://core.spreedly.com/checkout/sdk/1.3.1/index.js`](https://core.spreedly.com/checkout/sdk/1.3.1/index.js)
- Express Checkout: [`https://core.spreedly.com/checkout/elements/1.3.1/express-checkout.js`](https://core.spreedly.com/checkout/elements/1.3.1/express-checkout.js)
